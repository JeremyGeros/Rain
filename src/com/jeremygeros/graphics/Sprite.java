package com.jeremygeros.graphics;
...
public class Sprite {
	...
	public static Sprite player_forward = new Sprite(32, 1, 5, SpriteSheet.tiles);
	...
	private void load() {
		for (int y = 0; y < SIZE; y++) {
			for (int x = 0; x < SIZE; x++) {
				int sheetPixel = (x + this.x) + (y + this.y) * sheet.SIZE;
				pixels[x + y * SIZE] = sheet.pixels[sheetPixel];
			}
		}
	}
}
